...
SECRET_KEY = 'django-insecure-f_r=$asr8cm#gya_zg+3euev*=+0540^dt$*)-)*^tn13=6i@c'
...
EMAIL_HOST_PASSWORD = 'xyyl hugn fxeu kved'  # Use Gmail App Password
...
# ✅ SQLite DB (or change to MySQL/Postgres later)
DATABASES = {
    'default': {
